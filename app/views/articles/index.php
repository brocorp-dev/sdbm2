...
<?php include('app/views/_partials/navbar.php') ?>
  ...
  <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    <h2 class="text-2xl font-extrabold tracking-tight text-gray-900">Nos supers articles</h2>
        ...
        <div class="mt-4 flex justify-between">
          <div>
            <h3 class="text-sm text-gray-700">
              <a href="<?php echo('articles/'. $article['id'] . '/show') ?>">
          ...
          <p class="text-sm font-medium text-gray-900"><?php echo($article['price_ht']) ?> €</p>
        </div>
      </div>
