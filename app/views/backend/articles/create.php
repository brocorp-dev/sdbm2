<?php
  ...
  if(isset($_POST["item_name"]))
  {
        ...
        ArticleController::submit($name,$description,$price_ht);
          ...
          <div>
            <div>
              ...
              <p class="mt-1 max-w-2xl text-sm text-gray-500">
                Vous pouvez créer un nouvel article pour votre boutique.
              </p>
            </div>
            ...
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <input type="text" name="item_name" id="name" placeholder="nom article" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
            </div>
          </div>
            ...
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <input type="numeric" name="price_ht" id="price_ht" placeholder="prix ht" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
            </div>
          </div>
